...
public class MessageUtils {
   ...
   */
  public Message buildMessage(InputStream rawDataStream, String namespace) throws PropertyNotFoundException,
    MisconfiguredPropertyException, MessageParseException {
    ...
    if (!(messageFactoryObject instanceof MessageFactory)) {
      throw new MisconfiguredPropertyException(namespace, getPsKeyMessageFactory(), MessageFactory.class,
        messageFactoryObject.getClass());
    }
   ...
   */
  public Message extractSubMessage(Message message, String psNamespace, String psKey,
                                   boolean errorIfNotMapped) throws PropertyNotFoundException,
    MisconfiguredPropertyException, MessageAccessException {
    try {
      MessageAccessor messageAccessor = (MessageAccessor) propertyStore.getProperty(psNamespace, psKey,
  ...
  public List<Message> extractSubMessageList(Message message, String psNamespace, String psKey,
                                             boolean errorIfNotMapped) throws PropertyNotFoundException,
    MisconfiguredPropertyException, MessageAccessException {
    try {
      MessageAccessor messageAccessor = (MessageAccessor) propertyStore.getProperty(psNamespace, psKey,
      ...
      if (result instanceof List) {
        ...
        throw new MisconfiguredPropertyException("Namespace[" + psNamespace + "], key[" + psKey + "] when invoked is " +
          "returning[" + result.getClass() + "] but should be a List<Message>");
      }
    } catch (PropertyNotFoundException e) {
      if (errorIfNotMapped) {
        throw e;
   ...
   */
  @SuppressWarnings("unchecked")
  public List<String> extractConceptAsStringList(Message message, String psNamespace, String psKey,
                                                 boolean errorIfNotMapped) throws PropertyNotFoundException,
    MisconfiguredPropertyException, MessageAccessException {
    try {
      MessageAccessor messageAccessor = (MessageAccessor) propertyStore.getProperty(psNamespace, psKey,
      ...
      if (result instanceof List) {
        ...
        throw new MisconfiguredPropertyException("Namespace[" + psNamespace + "], key[" + psKey + "] when invoked is " +
          "returning[" + result.getClass() + "] but should be a List<String>");
      }
    } catch (PropertyNotFoundException e) {
      if (errorIfNotMapped) {
        throw e;
   ...
   */
  @SuppressWarnings("unchecked")
  public Object extractConcept(Message message, String psNamespace, String psKey, boolean errorIfNotMapped) throws
    PropertyNotFoundException, MisconfiguredPropertyException, MessageAccessException {
    try {
      MessageAccessor messageAccessor = (MessageAccessor) propertyStore.getProperty(psNamespace, psKey,
        MessageAccessor.class);
   ...
   */
  @SuppressWarnings("unchecked")
  public Object extractConcept(Message message, List<String> psNamespaces, String psKey,
                               boolean errorIfNotMapped) throws PropertyNotFoundException,
    MisconfiguredPropertyException, MessageAccessException {
    try {
      MessageAccessor messageAccessor = (MessageAccessor) propertyStore.getProperty(psNamespaces, psKey,
        MessageAccessor.class);
      return messageAccessor.invoke(message);
      ...
      if (errorIfNotMapped) {
        throw new MessageAccessException("Unable to extract a required value [" + psKey + "] from the message using" +
          " namespaces [" + psNamespaces + "]", e);
      }
    }
    return null;
  }
   ...
   * @throws MessageAccessException         Should the message part be inaccessible
   */
  public String extractConceptAsString(Message message, String psNamespace, String psKey,
                                       boolean errorIfNotMapped) throws PropertyNotFoundException,
    MisconfiguredPropertyException, MessageAccessException {
    try {
      MessageAccessor messageAccessor = (MessageAccessor) propertyStore.getProperty(psNamespace, psKey,
   ...
   * @throws MessageAccessException         Should the message part be inaccessible
   */
  public Message extractSubMessage(Message message, List<String> psNamespaces, String psKey,
                                   boolean errorIfNotMapped) throws PropertyNotFoundException,
    MisconfiguredPropertyException, MessageAccessException {
    try {
      MessageAccessor messageAccessor = (MessageAccessor) propertyStore.getProperty(psNamespaces, psKey,
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Message> extractSubMessageList(Message message, List<String> psNamespaces, String psKey,
                                             boolean errorIfNotMapped) throws PropertyNotFoundException,
    MisconfiguredPropertyException, MessageAccessException {
    try {
      MessageAccessor messageAccessor = (MessageAccessor) propertyStore.getProperty(psNamespaces, psKey,
      ...
      if (result instanceof List) {
        ...
        throw new MisconfiguredPropertyException("Namespace[" + psNamespaces + "], key[" + psKey + "] when invoked is" +
          " returning[" + result.getClass() + "] but should be a List<Message>");
      }
    } catch (PropertyNotFoundException e) {
      if (errorIfNotMapped) {
   ...
   * @throws MessageAccessException         Should the message part be inaccessible
   */
  public String extractConceptAsString(Message message, List<String> psNamespaces, String psKey,
                                       boolean errorIfNotMapped) throws PropertyNotFoundException,
    MisconfiguredPropertyException, MessageAccessException {
    try {
      MessageAccessor messageAccessor = (MessageAccessor) propertyStore.getProperty(psNamespaces, psKey,
   ...
   * @throws MessageAccessException         Should the message part be inaccessible
   */
  public Integer extractConceptAsInteger(Message message, List<String> psNamespaces, String psKey,
                                         boolean errorIfNotMapped) throws PropertyNotFoundException,
    MisconfiguredPropertyException, MessageAccessException {
