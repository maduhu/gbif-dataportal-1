...
public class GbifAppenderDaoOverride implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		org.apache.log4j.Logger log4jLogger = org.apache.log4j.Logger.getLogger(GbifAppenderDaoOverride.class);
		Enumeration<Appender> appenders = log4jLogger.getRootLogger().getAllAppenders();
