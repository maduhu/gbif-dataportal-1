		...
		public static String formatGeospatialIssue(int issue) {
			...
			if (issue != 0) {
				...
				if ((issue & GEOSPATIAL_PRESUMED_INVERTED_COORDINATES) != 0) {
					buffer.append(prefix + " latitude and longitude probably transposed");
					prefix = ";";
				}
				...
				if ((issue & GEOSPATIAL_COUNTRY_COORDINATE_MISMATCH) != 0) {
					buffer.append(prefix + " coordinates fall outside specified country");
					prefix = ";";
				}
				...
				if ((issue & GEOSPATIAL_PRESUMED_ALTITUDE_IN_FEET) != 0) {
					buffer.append(prefix + " presumed altitude fields supplied in feet");
				}
				if ((issue & GEOSPATIAL_PRESUMED_DEPTH_IN_FEET) != 0) {
					buffer.append(prefix + " presumed depth fields supplied in feet");
				}						
