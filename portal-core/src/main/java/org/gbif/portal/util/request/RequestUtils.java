...
public class RequestUtils {
   ...
   */
  public Object executeGetRequest(String request, ResponseReader handler) throws HttpException, IOException,
    Exception {
...
//			 So let's dump to string and read that
   ...
   */
  public Object executeGetRequest(String url, String requestContent, ResponseReader handler) throws HttpException,
   ...
   * @throws Exception
   */
  public Object executeGetRequest(String url, Map<String, String> kvContent, ResponseReader handler) throws
    HttpException, UnsupportedEncodingException, IOException, Exception {
    ...
    boolean first = true;
    for (Map.Entry<String, String> stringStringEntry : kvContent.entrySet()) {
      if (!first) {
        completeURL.append("&");
      }
      first = false;
      completeURL.append(stringStringEntry.getKey());
      completeURL.append("=");
      completeURL.append(stringStringEntry.getValue());
    }
    if (logger.isDebugEnabled())
      logger.debug("Encoded request: " + url);
