...
public class TemplateUtils {
	 ...
	 */
	public void merge(Template template, VelocityContext context, Writer writer) throws ResourceNotFoundException, ParseErrorException, MethodInvocationException, Exception {
	 ...
	 */
	public String merge(Template template, VelocityContext context) throws ResourceNotFoundException, ParseErrorException, MethodInvocationException, Exception {
	 ...
	 */
	public String getAndMerge(String location, VelocityContext context) throws ResourceNotFoundException, ParseErrorException, MethodInvocationException, Exception {
