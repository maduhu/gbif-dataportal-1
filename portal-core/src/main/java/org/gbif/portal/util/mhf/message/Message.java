...
public interface Message {
   ...
   */
  String getRawData() throws MessageAccessException;
   ...
   * @throws MessageAccessException If the data cannot be accessed
   */
  String getLoggableData() throws MessageAccessException;
   ...
   */
  Message getPart(Object location) throws MessageAccessException, MessageParseException;
   ...
   * @throws MessageParseException  If exception occured building a new Message from the part
   */
  List<Message> getParts(Object location) throws MessageAccessException, MessageParseException;
   ...
   * @throws MessageAccessException If exception occured locating the part
   */
  String getPartAsString(Object location) throws MessageAccessException;
   ...
   * @throws MessageAccessException If exception occured locating the parts
   */
  List<String> getPartsAsString(Object location) throws MessageAccessException;
}
