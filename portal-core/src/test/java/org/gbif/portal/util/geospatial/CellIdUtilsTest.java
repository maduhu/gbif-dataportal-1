...
public class CellIdUtilsTest extends TestCase {
  ...
  /**
   * Test method for {@link org.gbif.portal.util.geospatial.CellIdUtils#toCentiCellId(java.lang.Float,
   * java.lang.Float)}.
   */
  ...
  public void testToBoundingBox2() {
    assertEquals(new LatLongBoundingBox((float) -180.0, (float) -90.0, (float) -179.9, (float) -89.9),
      CellIdUtils.toBoundingBox(0, 0));
    assertEquals(new LatLongBoundingBox((float) -180.0, (float) -89.0, (float) -179.9, (float) -88.9),
      CellIdUtils.toBoundingBox(360, 0));
    assertEquals(new LatLongBoundingBox((float) -179.9, (float) -88.9, (float) -179.8, (float) -88.8),
      CellIdUtils.toBoundingBox(360, 11));
  }

  /**
   * The cells enclosed by should return cells that are partially enclosed also
   * Test method for {@link org.gbif.portal.util.geospatial.CellIdUtils#getCellsEnclosedBy(float, float, float,
   * float)}.
   */
