...
public class ImageUtilsTest extends TestCase {
	...
	public void testIsImageLoadable() {
		try {
			assertTrue(ImageUtils.isImageLoadable("http://www.gbif.org/images/spacer.gif"));
			assertTrue(ImageUtils.isImageLoadable("http://www.gbif.org/images/gbif_05.jpg"));
	...
	public void testScaleImage() {
		try {
			...
			assertTrue(ImageUtils.scaleImageAndWriteToFile("http://www.gbif.org/images/gbif_05.jpg", 20, 20, tmpDir+"/image.jpg", "JPEG"));
			assertTrue(ImageUtils.scaleImageAndWriteToFile("http://www.gbif.org/images/gbif_05.jpg", 200, 200,  tmpDir+"/image.jpg", "JPEG"));
			assertTrue(ImageUtils.scaleImageAndWriteToFile("http://ukmoths.org.uk/images/02286_Borkhausenia_minutella_3.jpg", 150, 150,  tmpDir+"/image.jpg", "JPEG"));
			assertFalse(ImageUtils.isImageLoadable("http://www.gbif.org/"));
		} catch (Exception e) {
			fail(e.toString());
		}
