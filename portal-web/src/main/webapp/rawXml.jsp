...
<xsl:stylesheet version="1.0"
   ...
   <xsl:import href="${pageContext.request.contextPath}/stylesheet/xmlverbatim.xsl" />
   ...
   <!-- CSS Stylesheet -->
   <xsl:param name="css-stylesheet" select="'${pageContext.request.contextPath}/skins/shared/xml.css'" />
