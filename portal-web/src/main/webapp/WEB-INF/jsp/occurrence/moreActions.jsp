		...
		<tbody>
			<tr valign="top">
				...
				<td>	
					<ul class="actionsListInline">
						<li>
							<c:if test="${viewName!='resultsTable'}"><a href="${pageContext.request.contextPath}/occurrences/searchWithTable.htm?<gbif:criteria criteria="${criteria}"/>"></c:if><spring:message code="occurrence.search.filter.action.viewtable"/><c:if test="${viewName!='resultsTable'}"></a></c:if>
						</li>		
						<li>
							<c:if test="${viewName!='resultsMap'}"><a href="${pageContext.request.contextPath}/occurrences/searchWithMap.htm?<gbif:criteria criteria="${criteria}"/>"></c:if><spring:message code="occurrence.search.filter.action.viewmap"/><c:if test="${viewName!='resultsMap'}"></a></c:if>
						</li>
					</ul>
				</td>
			</tr>
			<tr valign="top">
				...
				<td>	
					<ul class="actionsListInline">
						<li> 
							<c:if test="${viewName!='providerCounts'}"><a href="${pageContext.request.contextPath}/occurrences/searchProviders.htm?<gbif:criteria criteria="${criteria}"/>"></c:if><spring:message code="occurrence.switchto.provider.countview"/><c:if test="${viewName!='providerCounts'}"></a></c:if>			
						</li>
						<li> 
							<c:if test="${viewName!='resourceCounts'}"><a href="${pageContext.request.contextPath}/occurrences/searchResources.htm?<gbif:criteria criteria="${criteria}"/>"></c:if><spring:message code="occurrence.switchto.resources.countview"/><c:if test="${viewName!='resourceCounts'}"></a></c:if>			
						</li>
						<li> 
