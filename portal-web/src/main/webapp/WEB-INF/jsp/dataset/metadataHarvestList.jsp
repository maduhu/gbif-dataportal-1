...
<harvestList xmlns="eml://ecoinformatics.org/harvestList"
 ...
 <document xmlns="">
   ...
   <documentType><![CDATA[eml://ecoinformatics.org/eml-2.1.1]]></documentType>
   <documentURL><![CDATA[http://${header.host}${pageContext.request.contextPath}/datasets/resource/${dataResource.key}?schema=emlGBIF10]]></documentURL>
 </document>
</c:forEach>
</harvestList>