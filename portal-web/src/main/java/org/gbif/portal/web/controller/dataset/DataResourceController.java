...
//		}				
	...
	public ModelAndView view(String dataResourceKey, Map<String, String> propertiesMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		mav.addObject(citationTextModelKey, getCitationText(dataResource, urlBase));
...
//			mav.addObject("rootConcepts", rootConcepts);
	...
	/**
	 * Gets citation text for a Data Resource
	 * 
	 * @param resource
	 * @param urlBase
	 * @return
	 */
	public String getCitationText(DataResourceDTO resource, String urlBase) {
		StringBuffer sb = new StringBuffer();
		getCitationText(sb, resource, urlBase, getDateString(), true);
		return sb.toString();
	}
	
	/**
	 * Helper method for getting the citation text from a DatResource
	 * 
	 * @param sb
	 * @param resource
	 * @param urlBase
	 ...
	 * @param asHtml
	 */
	private void getCitationText(StringBuffer sb, DataResourceDTO resource, String urlBase, String dateString, boolean asHtml) {
		sb.append(resource.getCitableAgent() == null ? resource.getDataProviderName() : resource.getCitableAgent());
		sb.append(", ");
