 ...
 * @author trobertson
 */
public class I18nDateDecorator implements DisplaytagColumnDecorator {
	/**
	 * The key to resource bundle for the date format
	 */
	public static final String RESOURCE_BUNDLE_KEY = "I18nDateDecorator.date.format";
	...
	public Object decorate(Object columnValue, PageContext pageContext, MediaTypeEnum mte) throws DecoratorException {
        ...
        if (format == null) {
        	throw new DecoratorException(I18nDateDecorator.class, "No format found for current local and key [" + RESOURCE_BUNDLE_KEY + "]" );
