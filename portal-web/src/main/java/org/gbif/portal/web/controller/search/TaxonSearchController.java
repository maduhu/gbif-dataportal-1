...
public class TaxonSearchController extends SimpleSearchPagingController {
	...
	/**
	 * @see org.gbif.portal.web.controller.search.SimpleSearchPagingController#doQuery(java.lang.String, java.util.Map, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
	 */
	@Override
	public boolean doQuery(String searchString, SearchConstraints searchConstraints, Map<String, String> propertiesMap, HttpServletRequest request, HttpServletResponse response) throws ServiceException{
		...
		SearchResultsDTO searchResults = taxonomyManager.findTaxonConcepts(searchString, true, null, nubProviderDTO.getKey(), null, null, null, RequestContextUtils.getLocale(request).getLanguage(), null, allowUnconfirmedNames, sortAlphabetically, searchConstraints);
