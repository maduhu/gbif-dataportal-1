...
<body class="dataset">
    ...
    <span class="input_text">
      <input type="text" name="q" placeholder="Search species by name, taxon, place..."/>
			...
			<div class="results">
				<ul>
					<li><a href="/species/search.html" title="">2,183,212</a>total taxon</li>
					<li><a href="/species/search.html" title="">1,291,282</a>total species</li>
					<li class="last"><a href="/species/search.html" title="">121,251</a>name usages</li>
				</ul>
			</div>
		</div>
		<footer></footer>
