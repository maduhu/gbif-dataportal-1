...
<content tag="infoband">
	...
	<div class="box">
		<div class="content">
			...
			<a href="#" title="Download ocurrences" class="candy_blue_button download"><span>Download ocurrences</span></a>
		</div>
	</div>
	<!-- /box -->
</content>
...
<content tag="tabs">
	...
	<div id="tabs">
		<ul>
			<li class="selected"><a href="/dataset/detail"><span>Information</span></a></li>
			<li><a href="/dataset/activity"><span>Activity <sup>(2)</sup></span></a></li>
			<li><a href="/dataset/discussion"><span>Discussion <sup>(5)</sup></span></a></li>
		</ul>
	</div>
	<!-- /tabs-->
</content>
...
<article class="map">
	...
	<div class="content">
		...
		<div class="right">
			...
			<p><a href="#" title="View as points">view as points</a> | view as grid</p>
