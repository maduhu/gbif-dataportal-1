...
public class OccurrenceManagerImpl implements OccurrenceManager {
	...
	protected static Log logger = LogFactory.getLog(OccurrenceManagerImpl.class);	
	...
	public OccurrenceRecordDTO getOccurrenceRecordFor(String occurrenceRecordKey)
		...
		OccurrenceRecord occurrenceRecord = occurrenceRecordDAO.getOccurrenceRecordFor(occurrenceRecordId);
		return (OccurrenceRecordDTO) occurrenceRecordDTOFactory.createDTO(occurrenceRecord);
	}	
	...
	public ExtendedOccurrenceRecordDTO getExtendedOccurrenceRecordFor(
		...
		Long occurrenceRecordId = parseKey(occurrenceRecordKey);
		OccurrenceRecord occurrenceRecord = occurrenceRecordDAO.getOccurrenceRecordFor(occurrenceRecordId);
		return (ExtendedOccurrenceRecordDTO) extendedOccurrenceRecordDTOFactory.createDTO(occurrenceRecord);
	}	
	
	/**
	 * @see org.gbif.portal.service.OccurrenceManager#getOccurrenceRecordFor(java.lang.String, java.lang.String, java.lang.String)
	 */
	@SuppressWarnings("unchecked")
	public List<OccurrenceRecordDTO> getOccurrenceRecordByCodes(String institutionCode,
			String collectionCode, String catalogueNumber)
			throws ServiceException {
		List<OccurrenceRecord> occurrenceRecords = occurrenceRecordDAO.getOccurrenceRecordFor(institutionCode, collectionCode, catalogueNumber);
		return (List<OccurrenceRecordDTO>) occurrenceRecordDTOFactory.createDTOList(occurrenceRecords);
	}	
	...
	public List<TypificationRecordDTO> getTypificationRecordsForOccurrenceRecord(String occurrenceRecordKey) throws ServiceException {
		return (List<TypificationRecordDTO>) typificationRecordDTOFactory.createDTOList(typificationRecordDAO.getTypificationRecordsForOccurrenceRecord(parseKey(occurrenceRecordKey)));
	}
	
	/**
	 * TODO for performance reasons this should be refactored not to query for model entities to pass into
	 * DAO methods. Rather the DAO methods should be passed ids. 
	 * 
	 * @see org.gbif.portal.service.OccurrenceManager#findOccurrenceRecords(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, org.gbif.portal.dto.util.BoundingBoxDTO, org.gbif.portal.dto.util.TimePeriodDTO, boolean, org.gbif.portal.dto.util.SearchConstraints)
	 */
	public SearchResultsDTO findOccurrenceRecords(String dataProviderKey,
		...
		if (dataProviderKey != null) {
			...
			if (dataProvider == null) {
				throw new ServiceException("No DataProvider found for key " + dataProviderKey);
			}
		}
		...
		if (dataResourceKey != null) {
			...
			if (dataResource == null) {
				throw new ServiceException("No DataResource found for key " + dataResourceKey);
			}
		}
		...
		if (resourceNetworkKey != null) {
			...
			resourceNetwork = resourceNetworkDAO.getResourceNetworkFor(resourceNetworkId);
			
			if (resourceNetwork == null) {
				throw new ServiceException("No ResourceNetwork found for key " + resourceNetworkKey);
			}
		}
		...
		if (taxonConceptKey != null) {
			...
			if (taxonConcept == null) {
				throw new ServiceException("No TaxonConcept found for key " + taxonConceptKey);
			}
			
			// Perform our search using nub concepts
			if (!taxonConcept.getIsNubConcept() && taxonConcept.getPartnerConcept() != null) {
				taxonConcept = taxonConceptDAO.getTaxonConceptFor(taxonConcept.getPartnerConceptId());
			}
		}
	...
	/**
	 * @see org.gbif.portal.service.OccurrenceManager#findRawOccurrenceRecord(java.lang.String, java.lang.String)
	 */
	public SearchResultsDTO findRawOccurrenceRecord(String dataResourceKey,
		...
		List<RawOccurrenceRecord> results = rawOccurrenceRecordDAO.findRawOccurrenceRecord(
				parseKey(dataResourceKey), catalogueNumber, searchConstraints.getStartIndex(), searchConstraints.getMaxResults()+1);
		return rawOccurrenceRecordDTOFactory.createResultsDTO(results, searchConstraints.getMaxResults());
	}	
	
	/**
	 * @see org.gbif.portal.service.OccurrenceManager#getRawOccurrenceRecordFor(java.lang.String)
	 */
	public RawOccurrenceRecordDTO getRawOccurrenceRecordFor(String rawOccurrenceRecordKey)
			throws ServiceException {
		Long rawOccurrenceRecordId = parseKey(rawOccurrenceRecordKey);
		RawOccurrenceRecord rawOccurrenceRecord = rawOccurrenceRecordDAO.getRawOccurrenceRecordFor(rawOccurrenceRecordId);
		return (RawOccurrenceRecordDTO) rawOccurrenceRecordDTOFactory.createDTO(rawOccurrenceRecord);
	}	
	
	/**
	 * @see org.gbif.portal.service.OccurrenceManager#getKmlOccurrenceRecordFor(java.lang.String)
	 */	
	public KmlOccurrenceRecordDTO getKmlOccurrenceRecordFor(String occurrenceRecordKey) 
			throws ServiceException {
		Long occurrenceRecordId = parseKey(occurrenceRecordKey);
		OccurrenceRecord occurrenceRecord = occurrenceRecordDAO.getOccurrenceRecordFor(occurrenceRecordId);
		return (KmlOccurrenceRecordDTO) kmlOccurrenceRecordDTOFactory.createDTO(occurrenceRecord);
	}
	 ...
	 * DAO methods. Rather the DAO methods should be passed ids. 
	 * 
	 * @see org.gbif.portal.service.OccurrenceManager#countOccurrenceRecords(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, org.gbif.portal.dto.util.BoundingBoxDTO, org.gbif.portal.dto.util.TimePeriodDTO, org.gbif.portal.dto.util.SearchConstraints, boolean)
	 */
	public int countOccurrenceRecords(String dataProviderKey,
		...
		if (taxonConceptKey != null) {
			...
			// Perform our search using nub concepts
			if (taxonConcept.getIsNubConcept()!=null && !taxonConcept.getIsNubConcept() && taxonConcept.getPartnerConcept() != null) {
				taxonConcept = taxonConceptDAO.getTaxonConceptFor(taxonConcept.getPartnerConceptId());
			}
  ...
  public int getTotalGeoreferencedOccurrenceRecordCount() throws ServiceException {
	...
	public List<IdentifierRecordDTO> getIdentifierRecordsForOccurrenceRecord(String occurrenceRecordKey) throws ServiceException {
		return (List<IdentifierRecordDTO>) identifierRecordDTOFactory.createDTOList(identifierRecordDAO.getIdentifierRecordsForOccurrenceRecord(parseKey(occurrenceRecordKey)));
	}

	@SuppressWarnings("unchecked")
	public List<ImageRecordDTO> getImageRecordsForOccurrenceRecord(String occurrenceRecordKey) throws ServiceException {
		return (List<ImageRecordDTO>) imageRecordDTOFactory.createDTOList(imageRecordDAO.getImageRecordsForOccurrenceRecord(parseKey(occurrenceRecordKey)));
	}

	@SuppressWarnings("unchecked")
	public List<LinkRecordDTO> getLinkRecordsForOccurrenceRecord(String occurrenceRecordKey) throws ServiceException {
		return (List<LinkRecordDTO>) linkRecordDTOFactory.createDTOList(linkRecordDAO.getLinkRecordsForOccurrenceRecord(parseKey(occurrenceRecordKey)));
	}	
	...
	/**
	 * @param briefOccurrenceRecordDTOFactory the briefOccurrenceRecordDTOFactory to set
	 */
	 ...
	 */
	public void setOccurrenceRecordDTOFactory(DTOFactory occurrenceRecordDTOFactory) {
	...
	/**
	 * @param identifierRecordDTOFactory the identifierRecordDTOFactory to set
	 */
	public void setIdentifierRecordDTOFactory(DTOFactory identifierRecordDTOFactory) {
	...
	/**
	 * @param extendedOccurrenceRecordDTOFactory the extendedOccurrenceRecordDTOFactory to set
	 */
	...
	/**
	 * @param linkRecordDTOFactory the linkRecordDTOFactory to set
	 */
	...
	/**
	 * @param kmlOccurrenceRecordDTOFactory the kmlOccurrenceRecordDTOFactory to set
	 */
