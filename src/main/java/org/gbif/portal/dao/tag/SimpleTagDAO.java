...
public interface SimpleTagDAO {
	...
	public List<GeographicalCoverageTag> retrieveGeographicalCoverageTagsForEntity(
			final int tagId, final long entityId);

	public List<TemporalCoverageTag> retrieveTemporalCoverageTagsForEntity(
			final int tagId, final long entityId);

	public List<BiRelationTagDTO> retrieveBiRelationTagsForEntity(
			final int tagId, final long toEntityId);
