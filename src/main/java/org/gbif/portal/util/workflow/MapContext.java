...
public class MapContext extends HashMap implements ProcessContext {
	...
	/**
	 * @see org.gbif.portal.util.workflow.ProcessContext#isStopProcess()
	 */
	...
	public Object get(String key, Class expectedType, boolean exceptionIfNull) throws ContextCorruptException {
		...
		if (!expectedType.isAssignableFrom(contextObject.getClass())){
			throw new ContextCorruptException("Expecting context object to be of type["+ expectedType +"] but was of type[" + contextObject.getClass() + "]");
		}
		return super.get(key);
	}
	
	/**
	 * @see org.gbif.portal.util.workflow.ProcessContext#setStopProcess(boolean)
	 */
