...
public class LogEvent extends Enumeration implements Serializable {
  ...
  public static final LogEvent HARVEST_MULTIPLEPREFERREDIDENTIFICATIONS = new LogEvent
    ("harvestMultiplePreferredIdentifications", HARVEST_RANGE_START + 2);
  public static final LogEvent HARVEST_MULTIPLEUNPREFERREDIDENTIFICATIONS = new LogEvent
    ("harvestMultipleUnpreferredIdentifications", HARVEST_RANGE_START + 3);
  ...
  public static final LogEvent EXTRACT_SCIENTIFICNAMEPARSEISSUE = new LogEvent("extractScientificNameParseIssue",
    EXTRACT_RANGE_START + 2);
  public static final LogEvent EXTRACT_SCIENTIFICNAMEPARSECOUNT = new LogEvent("extractScientificNameParseCount",
    EXTRACT_RANGE_START + 3);
  public static final LogEvent EXTRACT_TAXONRANKPARSEISSUE = new LogEvent("extractTaxonRankParseIssue",
    EXTRACT_RANGE_START + 4);
  public static final LogEvent EXTRACT_BASISOFRECORDPARSEISSUE = new LogEvent("extractBasisOfRecordParseIssue",
    EXTRACT_RANGE_START + 5);
  public static final LogEvent EXTRACT_COUNTRYNAMEPARSEISSUE = new LogEvent("extractCountryNameParseIssue",
    EXTRACT_RANGE_START + 6);
  public static final LogEvent EXTRACT_GEOSPATIALISSUE = new LogEvent("extractGeospatialParseIssue",
    EXTRACT_RANGE_START + 7);
  public static final LogEvent EXTRACT_DUPLICATEREMOTECONCEPTID = new LogEvent("extractDuplicateRemoteConceptId",
    EXTRACT_RANGE_START + 8);
  public static final LogEvent EXTRACT_MISSINGPARENTTAXON = new LogEvent("extractMissingParentTaxon",
    EXTRACT_RANGE_START + 9);
  public static final LogEvent EXTRACT_MISSINGACCEPTEDTAXON = new LogEvent("extractMissingAcceptedTaxon",
    EXTRACT_RANGE_START + 10);
  public static final LogEvent EXTRACT_AMBIGUOUSSCIENTIFICNAME = new LogEvent("extractAmbiguousScientificName",
    EXTRACT_RANGE_START + 11);
  public static final LogEvent EXTRACT_TEMPORALISSUE = new LogEvent("extractTemporalParseIssue",
    EXTRACT_RANGE_START + 12);
  ...
  public static final LogEvent USAGE_DATASET_METADATA_VIEW = new LogEvent("datasetMetadataView",
    USAGE_RANGE_START + 1);
  ...
  public static final LogEvent USAGE_DATAPROVIDER_METADATA_VIEW = new LogEvent("dataproviderMetadataView",
    USAGE_RANGE_START + 6);
  public static final LogEvent USAGE_DATASET_OCCURRENCE_DOWNLOAD = new LogEvent("datasetOccurrenceDownload",
    USAGE_RANGE_START + 7);
  public static final LogEvent USAGE_DATASET_TAXONOMY_DOWNLOAD = new LogEvent("datasetTaxonomyDownload",
    USAGE_RANGE_START + 8);
