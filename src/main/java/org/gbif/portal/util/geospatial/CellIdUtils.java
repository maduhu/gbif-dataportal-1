...
public class CellIdUtils {
	 ...
	 */
	public static Set<Integer> getCellsEnclosedBy(float minLat, float maxLat, float minLong, float maxLong) throws UnableToGenerateCellIdException {
	 ...
	 */
	public static int[] getMinMaxCellIdsForBoundingBox(float minLongitude, float minLatitude, float maxLongitude, float maxLatitude) throws UnableToGenerateCellIdException{
	 ...
	 */
	public static Integer[] getCentiCellIdForBoundingBox(float minLongitude, float minLatitude, float maxLongitude, float maxLatitude) throws UnableToGenerateCellIdException {
	...
	private static boolean isBoundingBoxCentiCell(float minLongitude, float minLatitude, float maxLongitude, float maxLatitude) {
