...
public interface DataResourceManager {
   ...
   */
  public Long countDataProviders(String providerName, boolean fuzzy, String isoCountryCode, Date modifiedSince)
   ...
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public Long countDataResources(String resourceName, boolean fuzzy, String providerKey, String basisOfRecordCode,
      Date modifiedSince) throws ServiceException;
   ...
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public Long countResourceNetworks(String networkName, boolean fuzzy, String code, Date modifiedSince)
      throws ServiceException;
   ...
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public SearchResultsDTO findDataProviders(String providerName, boolean fuzzy, String isoCountryCode,
      Date modifiedSince, SearchConstraints searchConstraints) throws ServiceException;
   ...
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public SearchResultsDTO findDataResources(String resourceName, boolean fuzzy, String providerKey,
      String basisOfRecordCode, Date modifiedSince, SearchConstraints searchConstraints) throws ServiceException;
   ...
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public SearchResultsDTO findResourceNetworks(String networkName, boolean fuzzy, String code, Date modifiedSince,
   ...
   * @throws ServiceException
   */
  public List<CountDTO> getDataResourceWithOccurrencesFor(String taxonConceptKey, String rank, boolean georeferenced)
      throws ServiceException;
   ...
   * 
   * @return DataResourceDTO containing details of the latest datresource added to the system, null if system is
   *         currently empty
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  ...
  /**
   * Returns the Data Resource that is providing the Nub Taxonomy for the system.
   * 
   * @return DataResourceDTO containing details of this data resource, null if their isnt a nub provider
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
   ...
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public List<PropertyStoreNamespaceDTO> getPropertyStoreNamespacesForResourceAccessPoint(String resourceAccessPointKey)
      throws ServiceException;
   ...
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public List<ResourceAccessPointDTO> getResourceAccessPointsForDataResource(String dataResourceKey)
      throws ServiceException;
   ...
   * @return ResourceNetworkDTO containing details of this resource network, null if unable to find resource network for
   *         this key
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
