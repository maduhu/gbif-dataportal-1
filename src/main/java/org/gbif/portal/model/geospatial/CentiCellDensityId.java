...
/**
 * CentiCellDensityId represents the composite key for the CentiCell Density Model Object 
 */
public class CentiCellDensityId implements Serializable{
	/**
	 * Generated
	 */
	...
	/**
	 * The fourth part of the identifier for the cell
	 */
	 ...
	 */
	public void setCentiCellId(int centiCellId) {
