...
public class OccurrenceRecord extends ModelObject {
	...
	protected long dataProviderId=-1;
  protected long dataResourceId=-1;
  ...
  protected Date deleted;
	...
	/**
	 * @param bits bits to include in geospatialIssue 
	...
	/**
	 * @param bits bits to clear in geospatialIssue 
	 * @see org.gbif.portal.util.db.OccurrenceRecordUtils
	 */
	...
	/**
	 * @param bits bits to include in otherIssue 
	 * @see org.gbif.portal.util.db.OccurrenceRecordUtils
	 */
	...
	/**
	 * @param bits bits to clear in otherIssue 
	 * @see org.gbif.portal.util.db.OccurrenceRecordUtils
	 */
	...
	/**
	 * @param bits bits to include in taxonomicIssue 
	 * @see org.gbif.portal.util.db.OccurrenceRecordUtils
	 */
	...
	/**
	 * @param bits bits to clear in taxonomicIssue 
	 * @see org.gbif.portal.util.db.OccurrenceRecordUtils
	 */
	...
	/**
	 * @param catalogueNumberId The catalogueNumberId to set.
	 */
	...
	/**
	 * @param collectionCodeId The collectionCodeId to set.
	 */
	...
	/**
	 * @param institutionCodeId The institutionCodeId to set.
	 */
