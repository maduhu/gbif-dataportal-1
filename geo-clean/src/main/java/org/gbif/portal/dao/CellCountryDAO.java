...
public interface CellCountryDAO {
	...
	/**
	 * Gets the list of CellCountry objects that are associated with the cellid given
	 * @param isoContryCode To search for
	 * @return The list of CellCountry objects or an empty list
	 */
	 ...
	 * @param cellid to search for
	 * @param isoContryCode To search for
	 * @return The single CellCountry record object
	 */
	public CellCountry getByCellIdAndIsoCountryCode(int cellid, String isoCountryCode);
	
	/**
	 * Creates the record
	 * @param cellCountry record to create 
	 * @return The number of rows created
	 */
	public int create(CellCountry cellCountry);
}
