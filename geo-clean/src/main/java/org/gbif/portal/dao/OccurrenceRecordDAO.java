...
public interface OccurrenceRecordDAO {
	...
	/** 
	 * Gets a list of OccurrenceRecord having a geospatial issue 
	 * @param geospatialIssue
	 * @return List of OccurrenceRecord
	 */
	public List<OccurrenceRecord> getByGeospatialIssueNumber(int geospatialIssue);
